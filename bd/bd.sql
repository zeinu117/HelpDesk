...
INSERT INTO `helpdesk`.`t_cat_equipo` (`nombre`) VALUES ('Microfonos');
INSERT INTO `helpdesk`.`t_cat_equipo` (`nombre`) VALUES ('Proyector');
INSERT INTO `helpdesk`.`t_cat_equipo` (`nombre`) VALUES ('Audifonos');
INSERT INTO `helpdesk`.`t_cat_equipo` (`nombre`) VALUES ('Cable HDMI');
INSERT INTO `helpdesk`.`t_cat_equipo` (`nombre`) VALUES ('Cable de corriente');
INSERT INTO `helpdesk`.`t_cat_equipo` (`nombre`) VALUES ('Cable de red');